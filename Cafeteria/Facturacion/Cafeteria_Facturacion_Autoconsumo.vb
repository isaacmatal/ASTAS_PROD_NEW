...
Public Class Cafeteria_Facturacion_Autoconsumo
    ...
    Dim TipoSoli As Integer
    Dim factor_ As Decimal
    Dim Planta As Integer
    Dim fecha_impresion_ As Date
    Dim forzar_efectivo_ As Boolean

    Private Sub Cafeteria_Facturacion_Autoconsumo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.txtCodigoEmpleado.Text = CInt(c_data2.obtenerEscalar("SELECT VALOR FROM CONTABILIDAD_CATALOGO_CONSTANTE WHERE COMPAÑIA = " & Compañia & " AND CONSTANTE = 39")).ToString()
        ...
        Else
            ...
            Else
                ...
                Else
                    ...
                    txtPrecio.Text = Format(Val(Math.Round(roundd(CDbl(c_data2.obtenerEscalar("SELECT dbo.INVENTARIOS_CALCULAR_COSTOS(" & Compañia & ", " & Bodega & ", " & txtProducto.Text & ", CONVERT(DATETIME, '" & Format(Me.dtpFechaTrabajo.Value, "dd/MM/yyyy") & "', 103)) AS COSTO_PROD"))) * 1.13, 2, MidpointRounding.AwayFromZero)), "0.00")
                    'If factor_ > 0 Then
                    ...
                    '    txtPrecio.Text = Val(c_data2.leerDataeader("SELECT PRECIO_UNITARIO FROM INVENTARIOS_PRODUCTOS_BODEGAS WHERE COMPAÑIA=" & Compañia & " AND BODEGA=" & Bodega & " AND PRODUCTO=" & txtProducto.Text, 0))
                    'End If
                    Me.txtTotal.Text = Format(Val(txtPrecio.Text), "0.00")
    ...
    Public Sub GuardarFactura(ByVal PRODUCTO2, ByVal CANTIDAD, ByVal COSTO_UNI, ByVal PRECIO_UNITARIO)
        ...
        End If
        If codigo_buxi = "4" Then
            SQL = "UPDATE CAFETERIA_FACTURACION_ENCABEZADO SET ENVIADO = 1" & vbCrLf
            SQL &= " WHERE COMPAÑIA = " & Compañia & vbCrLf
            SQL &= "   AND BODEGA = " & Bodega & vbCrLf
            SQL &= "   AND SERIE_COMPLETA = '" & serie.Trim & "'" & vbCrLf
            SQL &= "   AND NUMERO_FACTURA = " & correlativo_Actual & vbCrLf
    ...
    Private Sub btnCargar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCargar.Click
        ...
        If (dgvDetalleVenta.RowCount <= 0) Then
            Try
                If Val(txtNumTicket.Text) > 0 Then
                    ...
                    If DS02.Tables(0).Rows(0).Item("CODIGO_EMPLEADO") <> 4 Then
                        MsgBox("Ticket no corresponde a autoconsumo", MsgBoxStyle.Information, "Cargar datos")
                        txtNumTicket.Clear()
                        Return
                    End If
                    bandera1 = True
    ...
    Private Sub btnMovProd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMovProd.Click
    ...
    Public Sub ReimprimirTicket()
        ...
        If (txtTotalPagar.Text > 200) Or anulado_ Then
            TICKET.EscribirTicket("")
    ...
    Private Sub txtCantidad_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCantidad.TextChanged
        Me.txtTotal.Text = Format(Val(txtCantidad.Text) * Val(Me.txtPrecio.Text), "0.00")
    End Sub

    Private Sub Cafeteria_Facturacion_Autoconsumo_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Function roundd(ByVal dec As Decimal) As Decimal
    ...
    'Private Sub Cafeteria_Facturacion_Autoconsumo_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
    ...
    Private Sub Cafeteria_Facturacion_Autoconsumo_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        'verificar si usuario tiene autorización de facturar autoconsumo
        Dim frmAutoConsumo As New Facturacion_Autorizaciones(1)
        frmAutoConsumo.ShowDialog()
        If frmAutoConsumo.idAutotizacion < 0 Then
