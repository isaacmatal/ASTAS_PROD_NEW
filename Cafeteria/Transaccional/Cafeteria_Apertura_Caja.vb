    ...
    Private Sub Cafeteria_Apertura_Caja_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Me.cbSeleccioneCaja.SelectedValue <> Nothing Then
            If cbCafeteria.SelectedValue = bodega_ataf Then
                c_data2.CargarCombo(Me.cbTiempoComida, "Execute sp_CAFETERIA_CATALOGO_TIEMPO_COMIDA " & Compañia & ", " & "'W'," & Me.cbSeleccioneCaja.SelectedValue, "Tiempo de Comida", "Descripción")
                Label2.Text = "ASOCIACION DE TRABAJADORES DE AVICOLA SALVADOREÑA Y FILIALES"
            Else
                c_data2.CargarCombo(Me.cbTiempoComida, "Execute sp_CAFETERIA_CATALOGO_TIEMPO_COMIDA " & Compañia & ", " & "'T'," & Me.cbSeleccioneCaja.SelectedValue, "Tiempo de Comida", "Descripción")
