...
Public Class Cafeteria_Cinta_Auditora_Digital
    Dim Sql As String
    ...
    Private Sub Cafeteria_Cinta_Auditora_Digital_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Iniciando = True
